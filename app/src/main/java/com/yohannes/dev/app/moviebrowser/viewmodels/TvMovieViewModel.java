...
public class TvMovieViewModel extends AndroidViewModel {

    private MutableLiveData<List<Movie>> moviesList;

    public TvMovieViewModel(@NonNull Application application){
        super(application);
    ...
    public void makeApiCall(){
        ...
        Call<MainResponse> mainResponseCall = netowrkApi.getResponse(getApplication().getString(R.string.api_key), Utils.LANGUAGE, 10770);
