...
public class ComedyViewModel extends AndroidViewModel {

    private MutableLiveData<List<Movie>> moviesList;
    private String apiKey;

    public ComedyViewModel(@NonNull Application application){
        super(application);
    ...
    public void makeApiCall(){
        ...
        Call<MainResponse> mainResponseCall = netowrkApi.getResponse(getApplication().getString(R.string.api_key), Utils.LANGUAGE, 35);
